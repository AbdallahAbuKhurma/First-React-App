...
class Main extends React.Component {
  ...
  render() {
    const list = this.state.HornedAnimals.map(element => {
      return (
        <HornedBeastes key = {element.title} imageUrl={element.imageUrl} title={element.title} alt={element.title} description={element.description} />
      );
